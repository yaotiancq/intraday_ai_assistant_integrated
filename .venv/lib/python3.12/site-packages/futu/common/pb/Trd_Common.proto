...
message TrdAcc
{
	...
	optional int32 securityFirm = 6; //所属券商，取值见Trd_Common.SecurityFirm
...
message Funds
{
	...
	optional int32 dtStatus = 29;				//日内交易限制情况，取值见 DTStatus
	...
	optional int32	exposureLevel = 35; //取值见ExposureLevel
...
message MaxTrdQtys
{
	...
	optional int32 session = 8;                 //美股订单时段, 参见Common.Session的枚举定义（最低 FutuOpenD 版本要求：9.4.5408）
}
