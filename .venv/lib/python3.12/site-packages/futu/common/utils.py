...
def split_stock_str(stock_str_param):
    ...
    # Reused by quote valuation APIs and other stock-code based requests.
...
class ProtobufMap(dict):
    ...
    def __init__(self):
        ...
        from .pb.Qot_GetFinancialsEarningsPriceMove_pb2 import Response as QotGetFinancialsEarningsPriceMoveResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetFinancialsEarningsPriceMove] = QotGetFinancialsEarningsPriceMoveResponse()
        from .pb.Qot_GetResearchMorningstarReport_pb2 import Response as QotGetResearchMorningstarReportResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetResearchMorningstarReport] = QotGetResearchMorningstarReportResponse()
        from .pb.Qot_GetResearchAnalystConsensus_pb2 import Response as QotGetResearchAnalystConsensusResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetResearchAnalystConsensus] = QotGetResearchAnalystConsensusResponse()
        from .pb.Qot_GetResearchRatingSummary_pb2 import Response as QotGetResearchRatingSummaryResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetResearchRatingSummary] = QotGetResearchRatingSummaryResponse()
        from .pb.Qot_GetShareholdersOverview_pb2 import Response as QotGetShareholdersOverviewResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetShareholdersOverview] = QotGetShareholdersOverviewResponse()
        from .pb.Qot_GetShareholdersInstitutional_pb2 import Response as QotGetShareholdersInstitutionalResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetShareholdersInstitutional] = QotGetShareholdersInstitutionalResponse()
        from .pb.Qot_GetShareholdersHoldingChanges_pb2 import Response as QotGetShareholdersHoldingChangesResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetShareholdersHoldingChanges] = QotGetShareholdersHoldingChangesResponse()
        from .pb.Qot_GetShareholdersHolderDetail_pb2 import Response as QotGetShareholdersHolderDetailResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetShareholdersHolderDetail] = QotGetShareholdersHolderDetailResponse()
        from .pb.Qot_GetInsiderHolderList_pb2 import Response as QotGetInsiderHolderListResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetInsiderHolderList] = QotGetInsiderHolderListResponse()
        from .pb.Qot_GetInsiderTradeList_pb2 import Response as QotGetInsiderTradeListResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetInsiderTradeList] = QotGetInsiderTradeListResponse()
        from .pb.Qot_GetDailyShortVolume_pb2 import Response as QotGetDailyShortVolumeResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetDailyShortVolume] = QotGetDailyShortVolumeResponse()
        from .pb.Qot_GetShortInterest_pb2 import Response as QotGetShortInterestResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetShortInterest] = QotGetShortInterestResponse()
        from .pb.Qot_GetOptionExerciseProbability_pb2 import Response as QotGetOptionExerciseProbabilityResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetOptionExerciseProbability] = QotGetOptionExerciseProbabilityResponse()
        from .pb.Qot_GetOptionVolatility_pb2 import Response as QotGetOptionVolatilityResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetOptionVolatility] = QotGetOptionVolatilityResponse()
        from .pb.Qot_GetFinancialsEarningsPriceHistory_pb2 import Response as QotGetFinancialsEarningsPriceHistoryResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetFinancialsEarningsPriceHistory] = QotGetFinancialsEarningsPriceHistoryResponse()
        from .pb.Qot_GetTopTenBuySellBrokers_pb2 import Response as QotGetTopTenBuySellBrokersResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetTopTenBuySellBrokers] = QotGetTopTenBuySellBrokersResponse()
        from .pb.Qot_GetFinancialsStatements_pb2 import Response as QotGetFinancialsStatementsResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetFinancialsStatements] = QotGetFinancialsStatementsResponse()
        from .pb.Qot_GetFinancialsRevenueBreakdown_pb2 import Response as QotGetFinancialsRevenueBreakdownResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetFinancialsRevenueBreakdown] = QotGetFinancialsRevenueBreakdownResponse()
        from .pb.Qot_GetCompanyProfile_pb2 import Response as QotGetCompanyProfileResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetCompanyProfile] = QotGetCompanyProfileResponse()
        from .pb.Qot_GetCompanyExecutives_pb2 import Response as QotGetCompanyExecutivesResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetCompanyExecutives] = QotGetCompanyExecutivesResponse()
        from .pb.Qot_GetCompanyExecutiveBackground_pb2 import Response as QotGetCompanyExecutiveBackgroundResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetCompanyExecutiveBackground] = QotGetCompanyExecutiveBackgroundResponse()
        from .pb.Qot_GetCompanyOperationalEfficiency_pb2 import Response as QotGetCompanyOperationalEfficiencyResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetCompanyOperationalEfficiency] = QotGetCompanyOperationalEfficiencyResponse()
        from .pb.Qot_GetCorporateActionsStockSplits_pb2 import Response as QotGetCorporateActionsStockSplitsResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetCorporateActionsStockSplits] = QotGetCorporateActionsStockSplitsResponse()
        from .pb.Qot_GetCorporateActionsBuybacks_pb2 import Response as QotGetCorporateActionsBuybacksResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetCorporateActionsBuybacks] = QotGetCorporateActionsBuybacksResponse()
        from .pb.Qot_GetCorporateActionsDividends_pb2 import Response as QotGetCorporateActionsDividendsResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetCorporateActionsDividends] = QotGetCorporateActionsDividendsResponse()
        from .pb.Qot_GetValuationDetail_pb2 import Response as QotGetValuationDetailResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetValuationDetail] = QotGetValuationDetailResponse()
        from .pb.Qot_GetValuationPlateStockList_pb2 import Response as QotGetValuationPlateStockListResponse
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetValuationPlateStockList] = QotGetValuationPlateStockListResponse()
        ...
        from .pb.Qot_StockScreen_pb2 import Response
        ProtobufMap.created_protobuf_map[ProtoId.Qot_StockScreen] = Response()

        from .pb.Qot_OptionScreen_pb2 import Response
        ProtobufMap.created_protobuf_map[ProtoId.Qot_OptionScreen] = Response()

        from .pb.Qot_WarrantScreen_pb2 import Response
        ProtobufMap.created_protobuf_map[ProtoId.Qot_WarrantScreen] = Response()
